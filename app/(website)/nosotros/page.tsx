...
const stats = [
  { value: "17+", label: "Años de experiencia", icon: HiOutlineClock },
  { value: "50+", label: "Vehículos en flota", icon: HiOutlineTruck },
  { value: "100+", label: "Clientes satisfechos", icon: HiOutlineUserGroup },
  { value: "24/7", label: "Disponibilidad", icon: HiOutlineGlobeAlt },
]
              ...
              >
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Flota de buses de Estrella de David"
                    fill
                    className="object-cover"
                  />
                </div>
